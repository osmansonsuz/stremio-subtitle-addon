...
function landingTemplate(manifest) {
	const background = manifest.background || 'https://www.sonsuzanime.com/wallpaper.jpg'
	...
	<body>
		<div id="addon">
			...
			<br>
			<br>
			<script type="text/javascript" src="https://cdnjs.buymeacoffee.com/1.0.0/button.prod.min.js" data-name="bmc-button" data-slug="sonsuzosman" data-color="#5F7FFF" data-emoji="☕"  data-font="Cookie" data-text="Destek olmak isteyenler için" data-outline-color="#000000" data-font-color="#ffffff" data-coffee-color="#FFDD00" ></script>
			<div class="separator"></div>
